var ski_url = "https://script.google.com/macros/s/AKfycbxB37QsQ5h-UuiCvKwN4uUu-iDL7ZKBdy-5i000k_-jgna-b_et4uDYp9VoPALktc7U/exec";
    ...
    function insert_ski() {
        ...
        var sku_1= $("#ski_sku_1").val();
        var sku_2= $("#ski_sku_2").val();
        var sku_3= $("#ski_sku_3").val();
        var sku_4= $("#ski_sku_4").val();
        var sku_5= $("#ski_sku_5").val();
        var sku_6= $("#ski_sku_6").val();
        var sku_7= $("#ski_sku_7").val();
        var sku_8= $("#ski_sku_8").val();
        var sku_9= $("#ski_sku_9").val();
        var sku_10= $("#ski_sku_10").val();
