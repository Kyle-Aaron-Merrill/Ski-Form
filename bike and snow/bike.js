var script_url = "https://script.google.com/macros/s/AKfycbyJWUYC9w3WKbChA5ew9yhFRWUOx9wMYyU9TRDK_mIHejLMWxYLZBKkFYH5R0IS9Rp-/exec";
  ...
  function insert_bike() {
    ...
    var url = script_url+"?callback=ctrlq&qty10="+qty10+"&qty9="+qty9+"&qty8="+qty8+"&qty7="+qty7+"&qty6="+qty6+"&qty5="+qty5+"&qty4="+qty4+"&qty3="+qty3+"&qty2="+qty2+"&qty1="+qty1+"&sku10="+sku10+"&sku9="+sku9+"&sku8="+sku8+"&sku7="+sku7+"&sku6="+sku6+"&sku5="+sku5+"&sku4="+sku4+"&sku3="+sku3+"&sku2="+sku2+"&sku1="+sku1+"&notes="+notes+"&size="+size+"&model="+model+"&make="+make+"&date="+date+"&repair_num="+repair_num+"&ph_num="+ph_num+"&l_name=" + l_name + "&f_name=" + f_name + "&action=insert";
    ...
    document.getElementById("TechM").reset();
...
$.getJSON(url, function (json) {
    ...
    // Set the variables from the results array
		...
		cell6.innerHTML = "<b>make_model</b>";
		cell7.innerHTML = "<b>notes</b>";
		cell8.innerHTML = "<b>Sku1</b>";
		cell9.innerHTML = "<b>sku2</b>";
		cell10.innerHTML = "<b>sku3</b>";
		cell11.innerHTML = "<b>sku4</b>";
		cell12.innerHTML = "<b>sku5</b>";
		cell13.innerHTML = "<b>sku6</b>";
		cell14.innerHTML = "<b>sku7</b>";
		cell15.innerHTML = "<b>sku8</b>";
		cell16.innerHTML = "<b>sku9</b>";
        cell17.innerHTML = "<b>sku10</b>";
        cell18.innerHTML = "<b>sku11</b>";		
        cell19.innerHTML = "<b>sku12</b>";		
        cell20.innerHTML = "<b>sku13</b>";		
        cell21.innerHTML = "<b>sku14</b>";		
        cell22.innerHTML = "<b>sku15</b>";		
        cell23.innerHTML = "<b>sku16</b>";
        cell24.innerHTML = "<b>sku17</b>";		
		cell25.innerHTML = "<b>sku18</b>";		
        cell26.innerHTML = "<b>sku19</b>";		
